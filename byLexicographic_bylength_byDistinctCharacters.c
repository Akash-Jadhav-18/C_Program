...
///////////////////////////////////////////////////////////////////////////////
//
//  Function name : strlenXX
//  Input : const char*
//  Output : Integer
//  Description : lengh of string
//
///////////////////////////////////////////////////////////////////////////////
...
int lexicographic_sort(const char* a, const char* b) {
    ...
    int a_size = strlenX(a);
    int b_size = strlenX(b);
    while(1)
    {
        if( (*a > *b) || (*a < *b) )
        {
...
int sort_by_length(const char* a, const char* b) {
    ...
    if(strlenX(a) > strlenX(b))
    {
        return SWAP;
    }
    else if(strlenX(a) == strlenX(b))
    {
        return lexicographic_sort(a,b);
    }
    else
...
int main() 
{
    ...
    for(int i = 0; i < n; i++){
        *(arr + i) = malloc(1024 * sizeof(char));
        scanf("%s", *(arr + i));
        *(arr + i) = realloc(*(arr + i), strlenX(*(arr + i)) + 1);
    }
